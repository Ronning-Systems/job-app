...
- **ATS Algorithms**: Understanding of how major ATS systems (Greenhouse, Lever, Workday, etc.) parse and rank resumes
...
Be specific and actionable. Prioritize changes that will have the biggest impact.
